...
public class GradeFileRepository extends InFileRepository<String, Grade> {
    ...
    Iterable<String> writeLine(Grade entity) {
        String l=entity.getId()+";"+entity.getProfessor()+";"+entity.getGrade_given()+";"+
                entity.getDeadline()+";"+entity.getFeedback()+";"+Constants.DATE_TIME_FORMATER.format(entity.getDate());
